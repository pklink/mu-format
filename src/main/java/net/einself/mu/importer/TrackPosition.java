 ...
 *
 * @param disc   {@code null} when the filename carried no disc, an {@link Integer} for numbered
 *               discs, a {@link String} for medium sides
 * @param number track number, always at least 1
 * @param title  the remainder of the filename
 */
