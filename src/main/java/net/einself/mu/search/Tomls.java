...
final class Tomls {
     ...
     */
    static String string(TomlTable table, String key) {
     ...
     */
    static String scalar(TomlTable table, String key) {
        TomlValue value = table.get(key);
        if (value == null || !value.isPrimitive()) {
            return null;
        }
     ...
     */
    static void put(Map<String, String> fields, String key, String value) {
        if (value != null) {
